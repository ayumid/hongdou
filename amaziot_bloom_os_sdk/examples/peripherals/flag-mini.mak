...
FEEDBACKFILE := $(TOP)\prebuilt\mini\feedbackLinkOpt.txt
OBJLIBLISTFILE := $(TOP)\prebuilt\mini\Arbel_PMD2NONE_targ_objliblist.txt
SCATTERFILE := $(TOP)\prebuilt\mini\Crane_DS_16M_Ram_16M_Flash_XIP_CIPSRAM_LteOnly.sct


COMMON_CFLAGS :=

COMMON_CFLAGS += --cpu Cortex-R4 --no_unaligned_access -g -O2 --apcs /inter --diag_suppress 2084,1,2,177,550,1296,2795,6319,9931,9933 --diag_error=warning --gnu --thumb --loose_implicit_cast 
