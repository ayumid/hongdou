...
#ifndef _LIB_LLCC68_H_
#define _LIB_LLCC68_H_
...
//extern RadioLoRaBandwidths_t LoRaBandwidth;

extern PacketParams_t SX1262_PacketParams;

extern ModulationParams_t SX1262_ModulationParams;

extern PacketStatus_t SX1262_PacketStatus;

    
extern SleepParams_t  SX1262_SleepParams;
 ...
 */
uint8_t SX1262_GetPayload( uint8_t *payload, uint8_t *size, uint8_t maxSize );
 ...
 *
 */
void SX1262_SetCrcPolynomial( uint16_t seed );
 ...
 */
void SX1262_SetStandby( RadioStandbyModes_t mode );
 ...
 */
void SX1262_GetRxBufferStatus( uint8_t *payloadLength, uint8_t *rxStartBuffer );
 ...
 */
uint8_t SX1262_GetDioStatus( void );
...
#endif /* ifndef _LIB_LLCC68_H_.2023-7-21 16:40:47 by: zhaoning */
