...
/* product Id  */
static char sg_product_id[MAX_SIZE_OF_PRODUCT_ID + 1] = "DEOSGEPZ7G";
...
static char sg_device_secret[MAX_SIZE_OF_DEVICE_SECRET + 1] = "8jS9NiTV48WRCOYWK+UrTA==";
#endif

#ifdef DEV_DYN_REG_ENABLED
/* product secret for device dynamic Registration  */
static char sg_product_secret[MAX_SIZE_OF_PRODUCT_SECRET + 1] = "ZR2K2Iuhx4Th498UU2pR3Rkd";
#endif
...
static int iot_parse_subdevinfo_from_json_file(DeviceInfo *pDevInfo, int *subDevNum)
{
    ...
    /*Get sub device num*/
    devNum = LITE_json_value_of(KEY_SUBDEV_NUM, JsonDoc);
    if (devNum) {
    ...
    /*Get sub info*/
    devList = LITE_json_value_of(KEY_SUBDEV_LIST, JsonDoc);
