...
void HAL_SleepMs(_IN_ uint32_t ms)
{
    ...
    OSATaskSleep(ticks ? ticks : 1); /* Minimum delay = 1 tick */
...
//#ifdef MULTITHREAD_ENABLED
//    if (!mutex) {
//        uprintf("%s: invalid mutex\n", __FUNCTION__);
//        return -1;
//    }

//    if (xSemaphoreTake(mutex, 0) != pdTRUE) {
//        uprintf("%s: xSemaphoreTake failed\n", __FUNCTION__);
//        return -1;
//    }
...
//        uprintf("thread name is required for FreeRTOS platform!\n");
//        return QCLOUD_ERR_INVAL;
//    }
...
//    if (ret != pdPASS) {
//        uprintf("%s: xTaskCreate failed: %d\n", __FUNCTION__, ret);
//        return QCLOUD_ERR_FAILURE;
//    }
...
//    if (osOK != ret) {
//        uprintf("HAL_SemaphoreDestroy err, err:%d\n\r", ret);
//    }
//}
...
//    if (osOK != ret) {
//        uprintf("HAL_SemaphorePost err, err:%d\n\r", ret);
//    }
//}
