...
#ifdef DTU_TYPE_CJSON_INCLUDE
#include "cJSON.h"
#endif /* ifdef DTU_TYPE_CJSON_INCLUDE.2023-10-30 18:35:01 by: zhaoning */
#ifdef DTU_TYPE_FORMAT_INCLUDE
#include "am_format.h"
#endif /* ifdef DTU_TYPE_FORMAT_INCLUDE.2023-12-11 15:40:47 by: zhaoning */
...
#define DTU_FORMAT_TYPE_NONE                      0
#define DTU_FORMAT_TYPE_HEX                       1
#define DTU_FORMAT_TYPE_JSON                      2

#define DTU_FORMAT_LEN                            4
...
#endif /* ifdef DTU_TYPE_FORMAT_INCLUDE.2023-12-7 14:20:34 by: zhaoning */

//#ifdef DTU_TYPE_AGNSS_INCLUDE

//#define DTU_AGNSS_USERNEME_LEN                   16
//#define DTU_AGNSS_PASSWORD_LEN                   16

//typedef struct
//{
//    UINT8 type;
//    UINT8 interval;
//    char uname[DTU_AGNSS_USERNEME_LEN];
//    char pwd[DTU_AGNSS_PASSWORD_LEN];
//}DTU_AGNSS_PARAM;

//#endif /* ifdef DTU_TYPE_AGNSS_INCLUDE.2024-1-3 10:01:00 by: zhaoning */

#ifdef DTU_TYPE_LORA_INCLUDE

#define DTU_LORA_TIMER_INTERVAL_MSG 1
#define DTU_LORA_TIMER_DATA_MSG 2
#define DTU_LORA_ID_MAX_LEN    10

#define DTU_LORA_CMD1  1
#define DTU_LORA_CMD2  2

#define DTU_LORA_CALL  1
#define DTU_LORA_TIME  2

#define DTU_LORA_SLAVE_NUM                      256//从机最大支持的数量

typedef struct _LORA_RCV_DATA_MSG_S
{
    UINT8 id;
    UINT32 len;//消息长度
    UINT8* data;
}LORA_RCV_DATA_MSG_T, *P_LORA_RCV_DATA_MSG_T;

typedef struct
{
    UINT16 id;
    UINT32 day_timestamp;
    char devid[DTU_LORA_ID_MAX_LEN];
}DTU_FORM_FILE_PARAM_T;
...
typedef struct
{
    ...
    char devid[DTU_LORA_ID_MAX_LEN];
    UINT8 cmd;
}__attribute__((packed)) DTU_LORA_DATA_HEAD_T;
...
typedef struct
{
    ...
    UINT8 cmd;
    UINT32 timetsamp;
}__attribute__((packed)) DTU_LORA_RES_DATA_HEAD_T;
...
typedef struct
{
    ...
    UINT8 interval;//指令之间间隔时间
    UINT16 delay;//指令循环完毕后等待时间
//    char prefix[DTU_LORA_ID_PREFIX_MAX_LEN];//指令循环完毕后等待时间
}DTU_LORA_PARAM;

typedef struct
{
    UINT32 id;//mod指令列表中的id
//    UINT32 timestamp;//modbus有两种指令，DTU_MODBUS_CMD_PARAM DTU_MODBUS_CMD_WN_PARAM，分两种状态轮训
    OSATimerRef lora_timer_ref;//指令发送间隔定时器
    OSATimerRef lora_call_ref;//指令发送间隔定时器
}DTU_LORA_T;

#endif /* ifdef DTU_TYPE_LORA_INCLUDE.2024-1-12 15:34:09 by: zhaoning */
...
#ifdef DTU_TYPE_FORMAT_INCLUDE
    DTU_FORMAT_PARAM format;
#endif /* ifdef DTU_TYPE_FORMAT_INCLUDE.2023-12-7 14:19:58 by: zhaoning */

//#ifdef DTU_TYPE_AGNSS_INCLUDE
//    DTU_AGNSS_PARAM agnss;
//#endif /* ifdef DTU_TYPE_AGNSS_INCLUDE.2024-1-3 10:00:15 by: zhaoning */

#ifdef DTU_TYPE_LORA_INCLUDE
    DTU_LORA_PARAM lora;
#endif /* ifdef DTU_TYPE_LORA_INCLUDE.2024-1-12 15:38:19 by: zhaoning */
}DTU_FILE_PARAM_T;
