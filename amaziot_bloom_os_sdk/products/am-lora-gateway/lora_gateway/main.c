...
void dtu_version_to_at_uart(void)
{
    ...
    snprintf(arrStr, 64, "%s", "AMAZIOT LORA GATEWAY\r\n");
...
#ifdef DTU_TYPE_LORA_CALL_INCLUDE
    //初始化巡检任务
    dtu_lora_call_task_init();
#endif /* ifdef DTU_TYPE_LORA_INCLUDE.2024-1-15 16:10:19 by: zhaoning */
#ifdef DTU_TYPE_LORA_TIME_INCLUDE
    //初始化定时上报任务
    dtu_lora_time_task_init();
#endif /* ifdef DTU_TYPE_LORA_TIME_INCLUDE.2024-1-15 16:10:19 by: zhaoning */
