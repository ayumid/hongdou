...
#ifdef DTU_UART_JHCL
    UINT8 linktype;
#endif /* ifdef DTU_UART_JHCL.2023-10-31 15:34:19 by: zhaoning */
...
#define DTU_DO_FLOW_AI_DD_OPH                    3//大于等于阈值输出高
#define DTU_DO_FLOW_AI_DD_OPL                    4//大于等于阈值输出低
#define DTU_DO_FLOW_AI_XD_OPH                    5//小于等于阈值输出高
#define DTU_DO_FLOW_AI_XD_OPL                    6//小于等于阈值输出低
...
#define DTU_CLK_INDEX_6                          6//闹钟5
#define DTU_CLK_INDEX_7                          7//闹钟5
#define DTU_CLK_INDEX_8                          8//闹钟5

typedef struct
{
    UINT8 di_edge;//DI 1 拉高 0 拉低
    UINT8 di_type;//2 定时上报 1 触发上报 0 不上报
    UINT32 di_interval;//上报间隔
}DTU_DI;
...
{
    UINT8 do_out;//掉电状态保存
    UINT8 do_type;//1 定时上报 0 不上报
    UINT32 do_interval;//上报间隔
    UINT8 do_status;//DO上电状态 2 上一次掉电前状态 1 上电高电平 0 上电低电平
...
typedef struct
{
    UINT8 do1_flow;//DO1 跟随状态
    UINT8 do2_flow;//DO2 跟随状态
    UINT8 do3_flow;//DO3 跟随状态
    UINT8 do4_flow;//DO4 跟随状态
    UINT8 do5_flow;//DO5 跟随状态
}DTU_FLOW_PARAM;
