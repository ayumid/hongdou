...
//    uprintf("%s %s\n", __FUNCTION__, rcvdata);
    ...
    if(NULL != gdicg)
    {
        ...
        if(NULL != data)
        {
            ...
            item = cJSON_GetObjectItem(data, "edg1");
            ...
            item = cJSON_GetObjectItem(data, "edg2");
            ...
            item = cJSON_GetObjectItem(data, "edg3");
            ...
            item = cJSON_GetObjectItem(data, "edg4");
            ...
            item = cJSON_GetObjectItem(data, "edg5");
            ...
            uprintf("DI1:type %d, interval %d, edge %d\r\n" \
                   "DI2:type %d, interval %d, edge %d\r\n" \
                   "DI3:type %d, interval %d, edge %d\r\n" \
                   "DI4:type %d, interval %d, edge %d\r\n" \
                   "DI5:type %d, interval %d, edge %d\r\n", 
...
//    uprintf("%s %s\n", __FUNCTION__, rcvdata);
    ...
    if(NULL != gdov)
    {
        ...
        if(NULL != data)
        {
            ...
            uprintf("DO1:%d, DO2:%d, DO3:%d, DO4:%d, DO5:%d", do1, do2, do3, do4, do5);
        }
        else
        {
            res = 1;
...
//            dtu_file_ctx->doo.do5.do_flip =  item->valueint;
            ...
            uprintf("DO1:type %d, interval %d, status %d\r\n" \
...
//            }
            ...
            uprintf("AI1:type %d, interval %d, rull %d, min %d, max %d\r\n", 
...
static void dtu_flow_json_get_flow_config_res(void)
{
    ...
    //按照协议，对象内加入成员
    cJSON_AddItemToObject(data, "flow1", cJSON_CreateNumber(dtu_file_ctx->flow.do1_flow));
    cJSON_AddItemToObject(data, "flow2", cJSON_CreateNumber(dtu_file_ctx->flow.do2_flow));
    cJSON_AddItemToObject(data, "flow3", cJSON_CreateNumber(dtu_file_ctx->flow.do3_flow));
    cJSON_AddItemToObject(data, "flow4", cJSON_CreateNumber(dtu_file_ctx->flow.do4_flow));
    cJSON_AddItemToObject(data, "flow5", cJSON_CreateNumber(dtu_file_ctx->flow.do5_flow));
...
//    uprintf("%s %s\n", __FUNCTION__, rcvdata);
    ...
    if(NULL != sfcg)
    {
        ...
        {
            uprintf("data:%s",cJSON_Print(data));
            item = cJSON_GetObjectItem(data, "flow1");
            dtu_file_ctx->flow.do1_flow = item->valueint;
            item = cJSON_GetObjectItem(data, "flow2");
            dtu_file_ctx->flow.do2_flow =  item->valueint;
            item = cJSON_GetObjectItem(data, "flow3");
            dtu_file_ctx->flow.do3_flow =  item->valueint;
            item = cJSON_GetObjectItem(data, "flow4");
            dtu_file_ctx->flow.do4_flow =  item->valueint;
            item = cJSON_GetObjectItem(data, "flow5");
            dtu_file_ctx->flow.do5_flow =  item->valueint;
...
static void dtu_clk_json_get_clk_config_res(void)
{
    ...
    //按照协议，对象内加入成员
    cJSON_AddItemToObject(data, "enClk1", cJSON_CreateNumber(dtu_file_ctx->clk.clk1.sw));
    cJSON_AddItemToObject(data, "hour1", cJSON_CreateNumber(dtu_file_ctx->clk.clk1.h));
    cJSON_AddItemToObject(data, "min1", cJSON_CreateNumber(dtu_file_ctx->clk.clk1.m));
    cJSON_AddItemToObject(data, "sec1", cJSON_CreateNumber(dtu_file_ctx->clk.clk1.s));
    cJSON_AddItemToObject(data, "channel1", cJSON_CreateNumber(dtu_file_ctx->clk.clk1.num));
    cJSON_AddItemToObject(data, "level1", cJSON_CreateNumber(dtu_file_ctx->clk.clk1.level));
    cJSON_AddItemToObject(data, "enClk2", cJSON_CreateNumber(dtu_file_ctx->clk.clk2.sw));
    cJSON_AddItemToObject(data, "hour2", cJSON_CreateNumber(dtu_file_ctx->clk.clk2.h));
    cJSON_AddItemToObject(data, "min2", cJSON_CreateNumber(dtu_file_ctx->clk.clk2.m));
    cJSON_AddItemToObject(data, "sec2", cJSON_CreateNumber(dtu_file_ctx->clk.clk2.s));
    cJSON_AddItemToObject(data, "channel2", cJSON_CreateNumber(dtu_file_ctx->clk.clk2.num));
    cJSON_AddItemToObject(data, "level2", cJSON_CreateNumber(dtu_file_ctx->clk.clk2.level));
    cJSON_AddItemToObject(data, "enClk3", cJSON_CreateNumber(dtu_file_ctx->clk.clk3.sw));
    cJSON_AddItemToObject(data, "hour3", cJSON_CreateNumber(dtu_file_ctx->clk.clk3.h));
    cJSON_AddItemToObject(data, "min3", cJSON_CreateNumber(dtu_file_ctx->clk.clk3.m));
    cJSON_AddItemToObject(data, "sec3", cJSON_CreateNumber(dtu_file_ctx->clk.clk3.s));
    cJSON_AddItemToObject(data, "channel3", cJSON_CreateNumber(dtu_file_ctx->clk.clk3.num));
    cJSON_AddItemToObject(data, "level3", cJSON_CreateNumber(dtu_file_ctx->clk.clk3.level));
    cJSON_AddItemToObject(data, "enClk4", cJSON_CreateNumber(dtu_file_ctx->clk.clk4.sw));
    cJSON_AddItemToObject(data, "hour4", cJSON_CreateNumber(dtu_file_ctx->clk.clk4.h));
    cJSON_AddItemToObject(data, "min4", cJSON_CreateNumber(dtu_file_ctx->clk.clk4.m));
    cJSON_AddItemToObject(data, "sec4", cJSON_CreateNumber(dtu_file_ctx->clk.clk4.s));
    cJSON_AddItemToObject(data, "channel4", cJSON_CreateNumber(dtu_file_ctx->clk.clk4.num));
    cJSON_AddItemToObject(data, "level4", cJSON_CreateNumber(dtu_file_ctx->clk.clk4.level));
    cJSON_AddItemToObject(data, "enClk5", cJSON_CreateNumber(dtu_file_ctx->clk.clk5.sw));
    cJSON_AddItemToObject(data, "hour5", cJSON_CreateNumber(dtu_file_ctx->clk.clk5.h));
    cJSON_AddItemToObject(data, "min5", cJSON_CreateNumber(dtu_file_ctx->clk.clk5.m));
    cJSON_AddItemToObject(data, "sec5", cJSON_CreateNumber(dtu_file_ctx->clk.clk5.s));
    cJSON_AddItemToObject(data, "channel5", cJSON_CreateNumber(dtu_file_ctx->clk.clk5.num));
    cJSON_AddItemToObject(data, "level5", cJSON_CreateNumber(dtu_file_ctx->clk.clk5.level));
...
//    uprintf("%s %s\n", __FUNCTION__, rcvdata);
    ...
    if(NULL != gclkcg)
    {
        ...
        {
            uprintf("data:%s",cJSON_Print(data));
            item = cJSON_GetObjectItem(data, "enClk1");
            dtu_file_ctx->clk.clk1.sw =  item->valueint;
            item = cJSON_GetObjectItem(data, "hour1");
            dtu_file_ctx->clk.clk1.h =  item->valueint;
            item = cJSON_GetObjectItem(data, "min1");
            dtu_file_ctx->clk.clk1.h =  item->valueint;
            item = cJSON_GetObjectItem(data, "sec1");
            dtu_file_ctx->clk.clk1.h =  item->valueint;
            item = cJSON_GetObjectItem(data, "channel1");
            dtu_file_ctx->clk.clk1.num =  item->valueint;
            item = cJSON_GetObjectItem(data, "level1");
            dtu_file_ctx->clk.clk1.level =  item->valueint;
            item = cJSON_GetObjectItem(data, "enClk2");
            dtu_file_ctx->clk.clk2.sw =  item->valueint;
            item = cJSON_GetObjectItem(data, "hour2");
            dtu_file_ctx->clk.clk2.h =  item->valueint;
            item = cJSON_GetObjectItem(data, "min2");
            dtu_file_ctx->clk.clk2.h =  item->valueint;
            item = cJSON_GetObjectItem(data, "sec2");
            dtu_file_ctx->clk.clk2.h =  item->valueint;
            item = cJSON_GetObjectItem(data, "channel2");
            dtu_file_ctx->clk.clk2.num =  item->valueint;
            item = cJSON_GetObjectItem(data, "level2");
            dtu_file_ctx->clk.clk2.level =  item->valueint;
            item = cJSON_GetObjectItem(data, "enClk3");
            dtu_file_ctx->clk.clk3.sw =  item->valueint;
            item = cJSON_GetObjectItem(data, "hour3");
            dtu_file_ctx->clk.clk3.h =  item->valueint;
            item = cJSON_GetObjectItem(data, "min3");
            dtu_file_ctx->clk.clk3.h =  item->valueint;
            item = cJSON_GetObjectItem(data, "sec3");
            dtu_file_ctx->clk.clk3.h =  item->valueint;
            item = cJSON_GetObjectItem(data, "channel3");
            dtu_file_ctx->clk.clk3.num =  item->valueint;
            item = cJSON_GetObjectItem(data, "level3");
            dtu_file_ctx->clk.clk3.level =  item->valueint;
            item = cJSON_GetObjectItem(data, "enClk4");
            dtu_file_ctx->clk.clk4.sw =  item->valueint;
            item = cJSON_GetObjectItem(data, "hour4");
            dtu_file_ctx->clk.clk4.h =  item->valueint;
            item = cJSON_GetObjectItem(data, "min4");
            dtu_file_ctx->clk.clk4.h =  item->valueint;
            item = cJSON_GetObjectItem(data, "sec4");
            dtu_file_ctx->clk.clk4.h =  item->valueint;
            item = cJSON_GetObjectItem(data, "channel4");
            dtu_file_ctx->clk.clk4.num =  item->valueint;
            item = cJSON_GetObjectItem(data, "level4");
            dtu_file_ctx->clk.clk4.level =  item->valueint;
            item = cJSON_GetObjectItem(data, "enClk5");
            dtu_file_ctx->clk.clk5.sw =  item->valueint;
            item = cJSON_GetObjectItem(data, "hour5");
            dtu_file_ctx->clk.clk5.h =  item->valueint;
            item = cJSON_GetObjectItem(data, "min5");
            dtu_file_ctx->clk.clk5.h =  item->valueint;
            item = cJSON_GetObjectItem(data, "sec5");
            dtu_file_ctx->clk.clk5.h =  item->valueint;
            item = cJSON_GetObjectItem(data, "channel5");
            dtu_file_ctx->clk.clk5.num =  item->valueint;
            item = cJSON_GetObjectItem(data, "level5");
            dtu_file_ctx->clk.clk5.level =  item->valueint;

            //写入文件
            dtu_trans_conf_file_write(dtu_file_ctx);
            
            uprintf("+CLK1:%d,%d,%d,%d,%d\r\n" \
                                         "+CLK2:%d,%d,%d,%d,%d\r\n" \
                                         "+CLK3:%d,%d,%d,%d,%d\r\n" \
                                         "+CLK4:%d,%d,%d,%d,%d\r\n" \
                                         "+CLK5:%d,%d,%d,%d,%d", 
...
//    uprintf("%s %s\n", __FUNCTION__, rcvdata);
    ...
    if(NULL != shtpc)
    {
        ...
        if(NULL != data)
        {
            ...
            dtu_file_ctx->http.config.type =  item->valueint;
            if(0 == dtu_file_ctx->http.config.type)
            {
                //打开心跳
                dtu_file_ctx->hb.heartflag = 1;
            }
...
//    uprintf("%s %s\n", __FUNCTION__, rcvdata);
    ...
    if(NULL != shtpc)
    {
        ...
        if(NULL != data)
        {
            ...
            if(NULL != item)
            {
                dtu_file_ctx->http.http1.type =  item->valueint;
            }
            else
            {
                dtu_file_ctx->http.http1.type =  0;
            }
            ...
            if(NULL != item)
            {
                dtu_file_ctx->http.http2.type =  item->valueint;
            }
            else
            {
                dtu_file_ctx->http.http2.type =  0;
            }
