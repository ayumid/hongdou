...
#define DTU_MODBUS_TASK_MSGQ_QUEUE_SIZE            (50)
...
/**
  * Function    : dtu_modbus_interval_timer_callback
  ...
  * Others      : 
  **/
void dtu_modbus_interval_timer_callback(UINT32 tmrId)
{
    int ret = 0;
    //发送消息到上报线程
    ...
    if (dtu_uart_ctx->uart_mode == DTU_DATA_MODE)
    {
        ...
        dtu_modbus_task_send_msgq(&uart_send);
    }
}

/**
  * Function    : dtu_modbus_interval_timer_init
