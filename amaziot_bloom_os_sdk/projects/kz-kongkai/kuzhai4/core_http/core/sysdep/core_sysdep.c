...
extern aiot_sysdep_portfile_t* aiot_sysdep_get_adapter_portfile(aiot_sysdep_portfile_t* portfile, int tls);
void aiot_sysdep_set_portfile(aiot_sysdep_portfile_t *portfile, int tls)
{
    g_sysdep_portfile = aiot_sysdep_get_adapter_portfile(portfile, tls);
}
