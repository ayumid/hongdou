...
void sample_sc7a20_detect_task(void *param)
{
    ...
    drv_tm7711_dout_pin_init();
    drv_tm7711_pdsck_pin_init();
    while(1)
    {
        ret = drv_tm7711_get_val(DRV_TM7711_CH1_10HZ, &data);
//        drv_tm7711_get_weight_value(0.15485, 0.416548615);
        sample_sc7a20_catstudio_printf("[APP] tm7711 data: 0x%x", data);
