...
static void file_download_event_cb(file_download_context_t* ctx, file_download_event_t* event)
{
    ...
    case DL_EVENT_ON_DATA:{
        printf("DL_EVENT_ON_DATA:%d", event->data_len);
        ...
        printf("File Download Percent: %d%%", percent);
    ...
    case DL_EVENT_FINISH:
        printf("DL_EVENT_FINISH");
        printf("File Download Percent: %d%%", 100);
